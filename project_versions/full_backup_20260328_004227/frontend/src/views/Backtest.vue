    ...
    <header class="page-header">
      <div class="header-content">
        <div class="header-left">
          <h1 class="page-title"><i class="fas fa-flask"></i> 回测中心</h1>
    ...
    <main class="main-content">
      ...
      <section class="quick-backtest-section">
        <div class="section-header">
          <h2><i class="fas fa-play-circle"></i> 快速回测</h2>
          <p>选择策略和参数进行快速回测</p>
        </div>
...
const lastYear = new Date(today.getFullYear() - 1, 0, 1) // 去年1月1日
const startDate = ref(lastYear.toISOString().split('T')[0])
