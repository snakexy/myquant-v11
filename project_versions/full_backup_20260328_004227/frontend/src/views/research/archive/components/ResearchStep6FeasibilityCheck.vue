<template>
  <div class="step-feasibility-check-panel">
    ...
    <div class="action-buttons">
      <button class="btn btn-primary" @click="runFeasibilityCheck" :disabled="isChecking">
        {{ isChecking ? (isZh ? '检查中...' : 'Checking...') : (isZh ? '开始检查' : 'Start Check') }}
      </button>
      <button class="btn btn-secondary" @click="exportReport" :disabled="!checkResults.completed">
        {{ isZh ? '导出报告' : 'Export Report' }}
      </button>
      <button class="btn btn-success" @click="completeStep" :disabled="!checkResults.overallPass">
