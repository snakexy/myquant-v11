...
class V5PyTdxPoolAdapter(V5DataAdapter):
            ...
            if quotes:
                for quote in quotes:
                    ...
                    if code:
                        ...
                        # 获取市场代码
                        market = batch[0][0] if batch else 0
                        # 获取财务信息（用于计算换手率）
    ...
    def _normalize_quote(
        ...
        return {
            ...
            'bid2_vol': quote.get('bid_vol2', 0),
            'ask2_vol': quote.get('ask_vol2', 0),
            'bid3': quote.get('bid3', 0),
            'ask3': quote.get('ask3', 0),
            'bid3_vol': quote.get('bid_vol3', 0),
            'ask3_vol': quote.get('ask_vol3', 0),
            'bid4': quote.get('bid4', 0),
            'ask4': quote.get('ask4', 0),
            'bid4_vol': quote.get('bid_vol4', 0),
            'ask4_vol': quote.get('ask_vol4', 0),
            'bid5': quote.get('bid5', 0),
            'ask5': quote.get('ask5', 0),
            'bid5_vol': quote.get('bid_vol5', 0),
            'ask5_vol': quote.get('ask_vol5', 0),
