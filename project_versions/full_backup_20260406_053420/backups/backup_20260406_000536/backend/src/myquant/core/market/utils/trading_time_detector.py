...
class TradingTimeDetectorV2:
    ...
    def get_phase_description(self, check_time: datetime = None) -> str:
        """
        获取当前时段的中文描述
        ...
        phase = self.get_trading_phase(check_time)
        descriptions = {
            TradingPhase.PRE_AUCTION: "开盘前",
            TradingPhase.MORNING_OPENING: "上午开盘 (9:30-10:00)",
            TradingPhase.MORNING_STABLE: "上午活跃 (10:00-11:30)",
            TradingPhase.LUNCH_BREAK: "午休 (11:30-13:00)",
            TradingPhase.AFTERNOON_OPENING: "下午开盘 (13:00-13:30)",
            TradingPhase.AFTERNOON_STABLE: "下午平稳 (13:30-15:00)",
            TradingPhase.CLOSED: "收盘后",
            TradingPhase.WEEKEND: "周末",
        }
    ...
    def get_cache_ttl(self) -> int:
        ...
        if phase == TradingPhase.PRE_AUCTION:
            return 10
