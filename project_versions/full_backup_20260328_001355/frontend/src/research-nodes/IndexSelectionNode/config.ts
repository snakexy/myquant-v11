...
// 节点配置
export const indexSelectionConfig: BaseNodeConfig = {
  id: 'index-selection',
  category: 'data-acquisition' as NodeCategory,
  icon: '📈',
  title: '指数选择',
  description: '选择指数并获取数据',
  x: 100,
  y: 260,
  params: {
    indexCode: '000001.SH', // 默认只选中上证指数
    frequency: 'daily',
...
// 默认参数
export const indexSelectionDefaultParams = {
  indexCode: '000001.SH',
  timeRange: '1M',
  startDate: '',
...
// 配置表单字段
export const indexSelectionConfigFields: ConfigField[] = [
  {
    name: 'indexCode',
    label: '指数代码',
    type: 'textarea',
    placeholder: '请输入指数代码，用逗号或换行分隔\n如：000001.SH, 399001.SZ',
    default: '000001.SH',
    required: true
  },
  {
