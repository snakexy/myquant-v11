  ...
  <div class="panel watchlist-panel">
    ...
    <div class="stock-list">
      ...
      >
        ...
        <!-- 迷你折线图（中列） -->
        <svg v-if="props.miniChartsData?.[item.symbol]?.length >= 2" class="mini-chart" viewBox="0 0 120 28" preserveAspectRatio="none">
          <polyline
            :points="sparklinePoints(props.miniChartsData[item.symbol])"
            fill="none"
