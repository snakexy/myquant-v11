      ...
      <main class="panel content-panel">
        <div class="content-area">
          ...
          <template v-if="currentStageModule === 'research'">
                ...
                <div class="quality-metrics-panel">
                  ...
                  <div class="quality-list">
                    ...
                    <div class="quality-item">
                      ...
                      <span class="quality-item-score" :style="{ color: getFactorQualityColor((stats.icMean / 0.05) * 80) }">{{ ((stats.icMean / 0.05) * 80).toFixed(1) }}</span>
                    ...
                    <div class="quality-item">
                      ...
                      <span class="quality-item-score" :style="{ color: getFactorQualityColor((stats.irRatio / 0.8) * 80) }">{{ ((stats.irRatio / 0.8) * 80).toFixed(1) }}</span>
                      <div class="quality-item-bar">
                    ...
                    <div class="quality-item">
                      ...
                      <span class="quality-item-score" :style="{ color: getFactorQualityColor(stats.passRate * 1.2) }">{{ (stats.passRate * 1.2).toFixed(1) }}</span>
                      <div class="quality-item-bar">
                    ...
                    <div class="quality-item">
                      ...
                      <span class="quality-item-score" :style="{ color: getFactorQualityColor((stats.totalFactors / 200) * 80) }">{{ ((stats.totalFactors / 200) * 80).toFixed(1) }}</span>
                      <div class="quality-item-bar">
                  ...
                  <div class="quality-total-score">
                    <div class="quality-total-header">
                      <span class="quality-total-label">{{ isZh ? '综合评分' : 'Total' }}</span>
                    </div>
            ...
            <div v-if="currentTab === 'ic-ir'" class="tab-pane active">
              <!-- 个体因子综合评估 -->
              <div class="single-factor-evaluation-section">
                <h3 class="section-title">
                  <svg class="section-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    <polygon points="12 2 2 7 12 12 22 7 12 2"></polygon>
                    <polyline points="2 17 12 22 22 17"></polyline>
                  ...
                  {{ isZh ? '个体因子综合评估' : 'Individual Factor Evaluation' }}
                </h3>
                <div class="evaluation-metrics-panel">
                  ...
                  <div class="evaluation-list">
                    ...
                    <div class="evaluation-item">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'IC均值' : 'IC Mean' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeIC(individualFactorData.ic_mean)) }">{{ normalizeIC(individualFactorData.ic_mean).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeIC(individualFactorData.ic_mean), 100) + '%', backgroundColor: getFactorQualityColor(normalizeIC(individualFactorData.ic_mean)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.ic_mean.toFixed(4) }}</span>
                    </div>
                    <!-- IC标准差 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'IC标准差' : 'IC Std' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeStd(individualFactorData.ic_std)) }">{{ normalizeStd(individualFactorData.ic_std).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeStd(individualFactorData.ic_std), 100) + '%', backgroundColor: getFactorQualityColor(normalizeStd(individualFactorData.ic_std)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.ic_std.toFixed(4) }}</span>
                    </div>
                    <!-- IC最大值 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'IC最大值' : 'IC Max' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeRange(individualFactorData.ic_max, -1, 1)) }">{{ normalizeRange(individualFactorData.ic_max, -1, 1).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeRange(individualFactorData.ic_max, -1, 1), 100) + '%', backgroundColor: getFactorQualityColor(normalizeRange(individualFactorData.ic_max, -1, 1)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.ic_max.toFixed(4) }}</span>
                    </div>
                    <!-- IC最小值 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'IC最小值' : 'IC Min' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeAbsMin(individualFactorData.ic_min)) }">{{ normalizeAbsMin(individualFactorData.ic_min).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeAbsMin(individualFactorData.ic_min), 100) + '%', backgroundColor: getFactorQualityColor(normalizeAbsMin(individualFactorData.ic_min)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.ic_min.toFixed(4) }}</span>
                    </div>
                    <!-- IR值 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'IR值' : 'IR' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeRange(individualFactorData.ir, -2, 2)) }">{{ normalizeRange(individualFactorData.ir, -2, 2).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeRange(individualFactorData.ir, -2, 2), 100) + '%', backgroundColor: getFactorQualityColor(normalizeRange(individualFactorData.ir, -2, 2)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.ir.toFixed(4) }}</span>
                    </div>
                    <!-- 正IC比率 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? '正IC比率' : 'IC+ Ratio' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(individualFactorData.ic_positive_ratio * 100) }">{{ (individualFactorData.ic_positive_ratio * 100).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: (individualFactorData.ic_positive_ratio * 100) + '%', backgroundColor: getFactorQualityColor(individualFactorData.ic_positive_ratio * 100) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ (individualFactorData.ic_positive_ratio * 100).toFixed(1) }}%</span>
                    </div>
                    <!-- t统计量 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 't统计量' : 't-Stat' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizeAbs(individualFactorData.t_stat, 5)) }">{{ normalizeAbs(individualFactorData.t_stat, 5).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizeAbs(individualFactorData.t_stat, 5), 100) + '%', backgroundColor: getFactorQualityColor(normalizeAbs(individualFactorData.t_stat, 5)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.t_stat.toFixed(4) }}</span>
                    </div>
                    <!-- p值 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? 'p值' : 'p-Value' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(normalizePValue(individualFactorData.p_value)) }">{{ normalizePValue(individualFactorData.p_value).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: Math.min(normalizePValue(individualFactorData.p_value), 100) + '%', backgroundColor: getFactorQualityColor(normalizePValue(individualFactorData.p_value)) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.p_value.toFixed(4) }}</span>
                    </div>
                    <!-- 单调性得分 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? '单调性' : 'Monotonicity' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(individualFactorData.monotonicity_score * 100) }">{{ (individualFactorData.monotonicity_score * 100).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: (individualFactorData.monotonicity_score * 100) + '%', backgroundColor: getFactorQualityColor(individualFactorData.monotonicity_score * 100) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.monotonicity_score.toFixed(2) }}</span>
                    </div>
                    <!-- 稳定性得分 -->
                    <div class="evaluation-item">
                      <div class="evaluation-item-icon">
                      ...
                      <span class="evaluation-item-label">{{ isZh ? '稳定性' : 'Stability' }}</span>
                      <span class="evaluation-item-score" :style="{ color: getFactorQualityColor(individualFactorData.stability_score * 100) }">{{ (individualFactorData.stability_score * 100).toFixed(1) }}</span>
                      <div class="evaluation-item-bar">
                        <div class="evaluation-bar-fill" :style="{ width: (individualFactorData.stability_score * 100) + '%', backgroundColor: getFactorQualityColor(individualFactorData.stability_score * 100) }"></div>
                      </div>
                      <span class="evaluation-item-raw">{{ individualFactorData.stability_score.toFixed(2) }}</span>
                    </div>
                    <!-- 综合总评分（在10个指标下方） -->
                    <div class="evaluation-total-score-inline">
                      <div class="total-inline-header">
                        <span class="total-inline-label">{{ isZh ? '综合评分' : 'Total Score' }}</span>
                      </div>
                      <div class="total-inline-content">
                        <div class="total-inline-value" :style="{ color: getFactorQualityColor(totalEvaluationScore) }">
                          {{ totalEvaluationScore.toFixed(1) }}
                        </div>
                        <!-- 星级和字母等级 -->
                        <div class="total-inline-rating">
                          <div class="star-rating-inline" :style="{ color: getFactorQualityColor(totalEvaluationScore) }">
                            <svg v-for="i in 5" :key="i" class="star-icon-inline" :class="{ filled: i <= getStarCount(totalEvaluationScore) }" viewBox="0 0 24 24" :fill="i <= getStarCount(totalEvaluationScore) ? 'currentColor' : 'none'" stroke="currentColor" stroke-width="1.5">
                              <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon>
                            </svg>
                          </div>
                          <div class="letter-grade-inline" :style="{ color: getFactorQualityColor(totalEvaluationScore) }">
                            {{ getLetterGrade(totalEvaluationScore) }}
                          </div>
                        </div>
                        <div class="total-inline-bar">
                          <div class="total-inline-fill" :style="{ width: Math.min(totalEvaluationScore, 100) + '%', backgroundColor: getFactorQualityColor(totalEvaluationScore) }"></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  <!-- 右侧：雷达图 -->
                  <div class="evaluation-radar-wrapper">
                    <div ref="individualFactorRadarRef" class="radar-chart"></div>
                  </div>
                </div>
              </div>
          ...
          <template v-else-if="currentStageModule === 'signal'">
            ...
            <div class="stats-grid">
              ...
              <div class="stat-card">
                <div class="stat-label">{{ isZh ? '信号准确率' : 'Accuracy' }}</div>
        ...
        <el-dialog v-model="showCustomStockDialog" width="500px" :show-close="true">
          ...
          <template #footer>
            ...
            <el-button @click="showCustomStockDialog = false" style="background: var(--accent-blue); border-color: var(--accent-blue); color: white;">{{ isZh ? '确定' : 'Confirm' }}</el-button>
          </template>
        </el-dialog>
      </main>
...
// 归一化辅助函数
const normalizeIC = (value: number) => Math.min((value / 0.05) * 80, 100)  // IC 5% = 80分
const normalizeStd = (value: number) => Math.min((1 - value / 0.15) * 100, 100)  // 标准差越小越好，反转
const normalizeRange = (value: number, min: number, max: number) => ((value - min) / (max - min)) * 100
const normalizeAbs = (value: number, max: number) => Math.min((Math.abs(value) / max) * 100, 100)
const normalizePValue = (value: number) => Math.min((1 - value / 0.05) * 100, 100)  // p值越小越好，反转
const normalizeAbsMin = (value: number) => Math.min((1 - Math.abs(value)) * 100, 100)  // IC最小值绝对值越小越好，越接近0越好
...
.quality-total-score {
  ...
  justify-content: center;
  padding: 12px;
  background: linear-gradient(135deg, rgba(239, 83, 80, 0.1) 0%, rgba(30, 34, 45, 0.8) 100%);
  border-radius: 12px;
  border: 1px solid var(--border-color);
  margin-left: 16px;
}
