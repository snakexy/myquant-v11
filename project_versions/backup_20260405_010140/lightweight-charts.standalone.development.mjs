/*!
 * @license
 * TradingView Lightweight Charts™ v5.1.0-dev+202603301718
...
function defaultTickMarkFormatter(timePoint, tickMarkType, locale) {
    ...
    switch (tickMarkType) {
        ...
        case 4 /* TickMarkType.TimeWithSeconds */:
            return `${String((date.getUTCHours() + 8) % 24).padStart(2, '0')}:${String(date.getUTCMinutes()).padStart(2, '0')}:${String(date.getUTCSeconds()).padStart(2, '0')}`;
        default:
            return '';
    }
}
