...
import { HitTestResult } from '../model/pane-hit-test';
...
export declare class PaneWidget implements IDestroyable, MouseEventHandlers {
    ...
    getBitmapSize(): Size;
    drawBitmap(ctx: CanvasRenderingContext2D, x: number, y: number, addTopLayer?: boolean): void;
    paint(type: InvalidationLevel): void;
    leftPriceAxisWidget(): PriceAxisWidget | null;
    rightPriceAxisWidget(): PriceAxisWidget | null;
    drawAdditionalSources(target: CanvasRenderingTarget2D, paneViewsGetter: ViewsGetter<IDataSourcePaneViews>): void;
