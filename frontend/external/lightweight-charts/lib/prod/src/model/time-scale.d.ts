...
import { IRange, Logical, LogicalRange, SeriesItemsIndexesRange, TickMarkWeightValue, TimedValue, TimePointIndex, TimePointsRange, TimeScalePoint } from './time-data';
/**
...
export declare class TimeScale<HorzScaleItem> implements ITimeScale {
    ...
    private _indicesWithData;
    private _indicesWithDataUpdateId;
    private _labels;
    private _conflationFactor;
    ...
    logicalRangeForTimeRange(range: IRange<InternalHorzScaleItem>): LogicalRange;
    width(): number;
    setWidth(newWidth: number): void;
    indexToCoordinate(index: TimePointIndex): Coordinate;
    indexesToCoordinates<T extends TimedValue>(points: T[], visibleRange?: SeriesItemsIndexesRange): void;
    coordinateToIndex(x: Coordinate, considerIgnoreWhitespace?: boolean): TimePointIndex;
    ...
    setVisibleRange(range: RangeImpl<TimePointIndex>, applyDefaultOffset?: boolean): void;
    fitContent(): void;
     ...
     */
    private _updateConflationFactor;
    ...
    private _shouldConsiderIndex;
    private _findNearestIndexWithData;
    private _checkRightOffsetPixels;
}
