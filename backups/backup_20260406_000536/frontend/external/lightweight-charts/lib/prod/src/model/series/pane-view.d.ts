...
export interface ISeriesCustomPaneView<HorzScaleItem = unknown, TData extends CustomData<HorzScaleItem> = CustomData<HorzScaleItem>> extends IUpdatablePaneView {
