...
export declare function getDashPattern(style: LineStyle, lineWidth: number): number[];
export declare function getDashPatternLength(dashPattern: number[]): number;
export declare function setLineStyle(ctx: CanvasRenderingContext2D, style: LineStyle): number[];
